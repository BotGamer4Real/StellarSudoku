  ...
  return (
    <Shell>
      ...
      <div className="help stack">
        <h2>Rules</h2>
        <p>Fill the 9×9 grid so each row, column, and 3×3 box contains the digits 1–9 once. Place by tap or by dragging a digit onto a cell. The pad is 1–9 left to right. Tap a filled cell or a pad digit to highlight every matching number on the board; the selected row, column, and box use a lighter wash of the same colour. Invalid moves flash the conflict and are not committed. A digit leaves the pad when all nine of that digit are on the board.</p>
        <h2>Coins</h2>
        ...
        <h2>Campaign</h2>
        <p>120 fixed puzzles, 20 per level. Finish all 20 in a level to unlock the next and earn that level’s achievement (Outpost, Station, Frontier, Observatory, Core, Abyss). Replays stay open.</p>
